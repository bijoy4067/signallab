...
trait SupportTicketManager
{
    ...
    public function viewTicket($ticket)
    {
        ...
        $extends = $user ? $this->activeTemplate.'layouts.master' : $this->activeTemplate.'layouts.frontend';

        return view($this->activeTemplate . $this->userType . '.support.view', compact('myTicket', 'messages', 'pageTitle', 'user', 'layout', 'extends'));
    }
