...
@section('panel')
    ...
    <form action="{{ route('admin.setting.notification.template.update',$template->id) }}" method="post">
        ...
        <div class="row">
            ...
            @if($template->act == 'SIGNAL_NOTIFICATION')
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-header bg--primary">
            ...
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-header bg--primary">
                        <h5 class="card-title text-white">@lang('Telegram Template')</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Status')</label>
                                    <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success"
                                       data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Send Telegram')"
                                       data-off="@lang("Don't Send")" name="telegram_status"
                                       @if($template->telegram_status) checked @endif>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Message')</label>
                                    <textarea name="telegram_body" rows="10" class="form-control" placeholder="@lang('Your message using short-codes')" required>{{ $template->telegram_body }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
