    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $signalStatistics['total'] }}</h3>
                    <p>@lang('Total Signals')</p>
                </div>
                <a href="{{ route('admin.signal.all') }}" class="widget-two__btn border border--primary btn-outline--primary">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $signalStatistics['sent'] }}</h3>
                    <p>@lang('Sent Signals')</p>
                </div>
                <a href="{{ route('admin.signal.sent') }}" class="widget-two__btn border border--success btn-outline--success">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $signalStatistics['notSent'] }}</h3>
                    <p>@lang('Not Sent Signals')</p>
                </div>
                <a href="{{ route('admin.signal.not.send') }}" class="widget-two__btn border border--warning btn-outline--warning">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__content">
                    <h3>{{ $totalPackage }}</h3>
                    <p>@lang('Total Packages')</p>
                </div>
                <a href="{{ route('admin.package.all') }}" class="widget-two__btn border border--primary btn-outline--primary">@lang('View All')</a>
            </div>
        </div>
    </div><!-- row end-->
