                        ...
                        <form action="{{route('user.deposit.insert')}}" method="post" class="transparent-form">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <select class="method form--control" name="gateway">
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="amount" class="form-control form--control" value="{{ old('amount') }}" autocomplete="off" required placeholder="@lang('Amount')">
                                        <span class="input-group-text bg--base text-white border-0">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                                <div class="preview-details d-none mt-2">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="btn btn--base deposit w-100 justify-content-center mt-4">@lang('Submit')</button>
                                </div>
                            </div>
                        </form>
                    </div>
